...
public class SurfaceMapper {
	...
	public SuperSurface createQuadSurface(int res) {
		SuperSurface s = new QuadSurface(parent, this, parent.mouseX, parent.mouseY, res, numAddedSurfaces);
		if (ccolor.length > 0)
	...
	public SuperSurface createQuadSurface(int res, int x, int y) {
		SuperSurface s = new QuadSurface(parent, this, x, y, res, numAddedSurfaces);
		if (ccolor.length > 0)
			s.setColor(ccolor[numAddedSurfaces % ccolor.length]);
		s.setModeCalibrate();
		surfaces.add(s);
	...
	public SuperSurface createBezierSurface(int res) {
		SuperSurface s = new BezierSurface(parent, this, parent.mouseX, parent.mouseY, res, numAddedSurfaces);
		if (ccolor.length > 0)
			s.setColor(ccolor[numAddedSurfaces % ccolor.length]);
		s.setModeCalibrate();
		surfaces.add(s);
	...
	public SuperSurface createBezierSurface(int res, int x, int y) {
		SuperSurface s = new BezierSurface(parent, this, x, y, res, numAddedSurfaces);
		if (ccolor.length > 0)
			s.setColor(ccolor[numAddedSurfaces % ccolor.length]);
		s.setModeCalibrate();
		surfaces.add(s);
